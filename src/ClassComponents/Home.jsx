...
export default class Home extends Component {
    ...
    fetchData = async () => {
        ...
        var response = ""
        if (this.props.search === "")
            response = await fetch(`https://newsapi.org/v2/everything?q=${this.props.q}&page${this.state.page}&language=${this.props.language}&page=${this.state.page}&pageSize=${this.props.pageSize}&apiKey=a86f22a30fb7431dbbcc8d0317b839ec`)
        else
            response = await fetch(`https://newsapi.org/v2/everything?q=${this.props.search}&page${this.state.page}&language=${this.props.language}&page=${this.state.page}&pageSize=${this.props.pageSize}&apiKey=a86f22a30fb7431dbbcc8d0317b839ec`)
        var result = await response.json()
        this.setState({
